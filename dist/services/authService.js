...
export const verifyGoogleTokenAndLogin = async (idToken, companyName) => {
    try {
        ...
        if (!user) {
            ...
            try {
                ...
                const userResult = await dbClient.query('INSERT INTO users (company_id, google_id, email, name, role) VALUES ($1, $2, $3, $4, $5) RETURNING *', [companyId, google_id, email, name, 'admin']);
